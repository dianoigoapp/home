...
import { Logo, BRAND_TAGLINE } from "../ui/Logo";
...
const SLIDES = [
  {
    ...
    texto:
      "Dianoigo significa abrir — o gesto de quem abre os olhos para ver, os ouvidos para ouvir, a mente para compreender. Este é o convite.",
    ref: "Lucas 24.45",
  },
  {
    fase: "02",
